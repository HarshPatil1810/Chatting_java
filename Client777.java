...
public class Client777 implements ActionListener {
    Panel sub;
JPanel p6;
JPanel p7;
JPanel p8;
...
JButton c,st,ser;
	...
	w.setBounds(45, 20, 20, 24);
	/*c=new JButton("Chat");
	c.setBounds(110, 15, 100, 18);
c.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent ae) {
             ser.setVisible(true);
 }});*/
	/*st=new JButton("Status");
	st.setBounds(60, 95, 123, 40);
	p.add(w);p.add(c);p.add(st);
	ser=new JButton("Client");
	ser.setBounds(70, 105, 123, 40);
...
JTabbedPane tp=new JTabbedPane();  
    ...
    p.add(tp);  
       ...
       ImageIcon i4 = new ImageIcon("E:/wall3.jpg");
